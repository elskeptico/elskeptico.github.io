...
function handleCommand(command) {
  let response = "";
  if (loginuser == false && loginpassword == false) {
    switch (command) {
      case "help":
    ...
    switch (userpassword) {
      case "oliver_eilers":
        response = "Username and password not- hey thats me!!";
        break;
      case "elskeptico_Captain17":
        response = "Admin account detected. Admin tools unlocked."
        break;
      case "_":
      ...
      default:
        response = "Username and password not recognized."
        break;
    }
    loginuser = false;
    loginpassword = false;
